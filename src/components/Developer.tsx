          ...
          <div className="@container">
            <div className="flex flex-col gap-12 items-center text-center">
              <div className="relative group">
                <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-primary to-cyan-400 opacity-25 blur transition duration-500 group-hover:opacity-75"></div>
              ...
              <div className="flex flex-col gap-4 max-w-3xl">
                <h1 className="text-black dark:text-white text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-[-0.033em]">
                  Engineered for <span className="text-primary">Scale</span> &amp; Performance.
                </h1>
                <p className="text-black/60 dark:text-white/60 text-lg md:text-xl font-normal leading-relaxed max-w-2xl mx-auto">
                  Fullstack Engineer with 10+ years specializing in React, Spring Boot, and AWS
                  architecture. Crafting high-performance web applications with clean code and
                  robust engineering.
                </p>
              </div>
